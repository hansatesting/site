    ...
    <section class="view intro-2 hm-gradient">
        <div class="full-bg-img">
            <div class="container flex-center">
                <h3 class="cart-head">Process Order</h3>
            ...
            <div class="container con-addpdct">
                <div class="col-lg-12">
                            ...
                            echo '<th>Amount</th>';
                            echo '<th>Order UserId</th>';
                            echo '<th>User Address</th>';
                            echo '<th>Dilivered</th>';
                            ...
                            while($row = mysqli_fetch_array($result))
                            {
                                ...
                                echo "<td>" . $row['product_productId'] . "</td>";
                                echo "<td>" . $row['amount'] . "</td>";
                                echo "<td>" . $row['order_user_userId'] . "</td>";
                                echo "<td>" . $row['order_address'] . "</td>";
                                echo "<td>
                                <form action='ProcessComplete.php' method='post'>
                                <input type='hidden' id='orderDetailId' name='orderDetailId' value=".$row['orderDetailId'].">
                                <input type='hidden' id='order_user_userId' name='order_user_userId' value=".$row['order_user_userId'].">
                                <input type='hidden' id='statuss' name='statuss' value='Delivered'>
                                <input class='btn btn-primary' type='submit' value='Delivered'>
                                </form>
                                </td>";
                                echo "</tr>";
